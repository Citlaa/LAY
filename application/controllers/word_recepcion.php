...
class Word_recepcion extends CI_Controller{
  ...
  function index($idRecepcion)
  {
    ...
    $section->addText($recepcion, array("size"=>10,"bold"=>true));
    ...
    $filename = "DenunciasPorRecepcion.docx";
