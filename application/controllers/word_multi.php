...
class Word_Dependencias extends CI_Controller{
  ...
  function index($idDependencia, $fechai, $fechaf)
  {
    ...
    // Query
    $resultados = $this->model_denuncias->by_multifiltro($idDependencia, $fechai, $fechaf);
    ...
    $filename = "DenunciasPorMultifiltro.docx";
