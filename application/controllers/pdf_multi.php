...
class Pdf_multi extends CI_Controller
{
   ...
   public function index($idDependencia, $fechai, $fechaf)
   {
      ...
      $data['username'] = $this->tank_auth->get_username();
         ...
         $data = array(
           'denuncias' => $this->model_denuncias->by_multifiltro($idDependencia, $fechai, $fechaf),
           ...
           $this->html2pdf->html(utf8_encode($this->load->view('pdf_multi', $data, true)));
   ...
   public function mail_pdf()
   {
       ...
       //datos que queremos enviar a la vista, lo mismo de siempre
       $data = array(
           'denuncias' => $this->model_dependencias->by_multifiltro($idDependencia, $fechai, $fechaf)
       );
