...
class Pdf_estatus extends CI_Controller
{
   ...
   public function index($idEstatus = 1)
   {
       ...
       $this->html2pdf->html(utf8_encode($this->load->view('pdf_denuncia/pdf_estatus', $data, true)));
