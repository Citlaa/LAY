...
class Word_periodo extends CI_Controller{
  ...
  function index($fechai, $fechaf)
  {
    ...
    // Query
    $resultados = $this->model_denuncias->by_periodo($fechai, $fechaf);
    $periodo = "Reporte del ". $fechai." al ".$fechaf; 
    ...
    $section->addText($periodo, array("size"=>10,"bold"=>true));
    ...
    $filename = "DenunciasPorPeriodo.docx";
